...
public class DBConstants {
     ...
     */
    public static final String GET_RECURRENT_VEHICLE = "select datediff(IN_TIME, CURRENT_TIMESTAMP ) as different_days from prod.ticket where ticket.VEHICLE_REG_NUMBER = ? and OUT_TIME is not NULL ";
}
